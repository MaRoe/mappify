(function () {
    ...
    function MappifyController($scope, $q, $rootScope, $http, $compile, $log, MarkerGeneratorService, mappifyConfiguration) {
        ...
        // should be call by all map controller methods to verify preconditions
